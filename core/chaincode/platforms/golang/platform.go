...
import (
	...
	"github.com/zhangwanbing1/fabric/core/chaincode/platforms/util"
...
func (goPlatform *Platform) GetDeploymentPayload(path string) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/zhangwanbing1/fabric/core/chaincode/shim": true,
		"github.com/zhangwanbing1/fabric/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/zhangwanbing1/fabric/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
